...
var $author$project$Test$Generated$Main3919827490$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/couragemouse/PhotoGroove/tests/PhotoGrooveTests.elm']),
		processes: 2,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 320324552000874
	},
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'PhotoGrooveTests',
				_List_fromArray(
					[$author$project$PhotoGrooveTests$clickThumbnail, $author$project$PhotoGrooveTests$decoderTest, $author$project$PhotoGrooveTests$noPhotosNoThumbnails, $author$project$PhotoGrooveTests$sliders, $author$project$PhotoGrooveTests$thumbnailsWork]))
			])));
_Platform_export({'Test':{'Generated':{'Main3919827490':{'init':$author$project$Test$Generated$Main3919827490$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-8276.sock";
